...
module.exports = function() {
    ...
    //it from the coordsArray.
        ...
        console.log('About to try to expand random from relative '+randomNode.x+','+randomNode.y);
        ...
        } else if (this.coords.failedGrid.hasOwnProperty(randomNode.x)
                //&& this.coords.failedGrid[randomNode.x].hasOwnProperty(randomNode.y+1)
            ) {
            console.log ('Coordinate '+randomNode.x+','+(randomNode.y+1)+' has already failed.');
        }
        ...
        } else if (this.coords.failedGrid.hasOwnProperty(randomNode.x+1)
                //&& this.coords.failedGrid[randomNode.x+1].hasOwnProperty(randomNode.y)
            ) {
            console.log ('Coordinate '+(randomNode.x+1)+','+(randomNode.y)+' has already failed.');
        }
        if (!this.coords.grid[randomNode.x].hasOwnProperty(randomNode.y-1)
            && (!this.coords.failedGrid.hasOwnProperty(randomNode.x)
                || !this.coords.failedGrid[randomNode.x].hasOwnProperty(randomNode.y-1)
